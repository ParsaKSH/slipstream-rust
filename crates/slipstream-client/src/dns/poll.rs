...
pub(crate) async fn send_poll_queries(
    ...
    local_addr_storage: &mut slipstream_ffi::sockcompat::sockaddr_storage,
    dns_id: &mut u16,
    ...
    *remaining = 0;
    ...
    while remaining_count > 0 {
        ...
        let mut addr_to: slipstream_ffi::sockcompat::sockaddr_storage =
            unsafe { std::mem::zeroed() };
        let mut addr_from: slipstream_ffi::sockcompat::sockaddr_storage =
            unsafe { std::mem::zeroed() };
